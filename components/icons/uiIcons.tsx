...
export const MoneyIcon = ({ className }: { className?: string }) => (
  <img
    src="https://raw.githubusercontent.com/nadirasetya13-code/asset-profile/Game/icon/cash.png"
    alt="Uang Kas"
    className={`w-auto ${className}`}
  />
);

export const ReputationIcon = ({ className }: { className?: string }) => (
...
export const SavingsIcon = ({ className }: { className?: string }) => (
  <img
    src="https://raw.githubusercontent.com/nadirasetya13-code/asset-profile/Game/icon/Tabungan.png"
    alt="Tabungan"
    className={`w-auto ${className}`}
  />
);
...
export const BuffIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
